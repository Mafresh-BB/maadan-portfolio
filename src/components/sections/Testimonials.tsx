        ...
        <div className="grid md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            <RevealOnScroll key={index}>
              <div className="bg-gray-50 dark:bg-gray-700/50 p-8 rounded-3xl border border-gray-100 dark:border-gray-700 relative group hover:-translate-y-1 transition-transform duration-300">
