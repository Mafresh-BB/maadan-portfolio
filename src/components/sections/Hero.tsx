...
export const Hero = ({ scrollToContact }: { scrollToContact: () => void }) => {
  ...
  return (
    <section
      id="home"
      className="pt-16 pb-12 sm:pt-24 sm:pb-16 lg:pt-36 lg:pb-24 px-4 relative overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors duration-300"
    >
        ...
        <RevealOnScroll>
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
            <div className="flex-1 space-y-6 md:space-y-8 text-center md:text-left z-10">
              {/* Status Badge */}
              <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-xs md:text-sm font-semibold border border-blue-100 dark:border-blue-800 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center md:justify-start">
                <button
                  ...
                  className="px-6 py-3 sm:px-8 sm:py-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 dark:shadow-blue-900/20 hover:shadow-blue-400/50 hover:-translate-y-1 flex items-center justify-center gap-2
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-6 py-3 sm:px-8 sm:py-4 bg-white dark:bg-gray-800 text-gray-800 dark:text-white font-bold rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all hover:border-gray-300 dark:hover:border-gray-600 hover:-translate-y-1 flex items-center justify-center gap-2 shadow-sm
                             focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-50 dark:focus-visible:ring-offset-gray-900"
                >
                  <Download size={20} />
                  View CV
