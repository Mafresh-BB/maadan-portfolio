...
export const Hero = ({ scrollToContact }: { scrollToContact: () => void }) => {
  return (
    <section id="home" className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 relative overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        <div className="absolute inset-0 bg-grid-pattern opacity-[0.4] -z-10"></div>
        {/* Blobs opacity lowered in dark mode */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-16">
            <div className="flex-1 space-y-8 text-center md:text-left z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-sm font-semibold border border-blue-100 dark:border-blue-800 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-white leading-tight tracking-tight animate-in fade-in slide-in-from-bottom-6 duration-1000">
                Hi, I'm <br />
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-lg mx-auto md:mx-0 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100">
                {personalInfo.about}
              </p>
              ...
              <div className="flex gap-6 pt-8 text-gray-500 dark:text-gray-400 justify-center md:justify-start">
                  ...
                  <div className="absolute inset-0 bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col items-center justify-center group hover:scale-[1.02] transition-transform duration-500">
                      ...
                      {personalInfo.avatar ? (
                        ...
                        <div className="flex-1 w-full p-8 flex flex-col items-center justify-center bg-dot-pattern">
                           <div className="w-32 h-32 bg-blue-50 dark:bg-gray-700 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                              <Code2 size={64} className="text-blue-600 dark:text-blue-400" />
                           </div>
                           <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{personalInfo.name}</h3>
