        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {projects.map((project, index) => (
            <RevealOnScroll key={index}>
              <div className="group flex flex-col h-full bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-2xl hover:shadow-blue-500/10 dark:hover:shadow-blue-900/20 hover:border-blue-200 dark:hover:border-blue-800 transition-all duration-500 overflow-hidden hover:-translate-y-2 backdrop-blur-sm">
                ...
                <div className="p-6 md:p-8 flex flex-col grow">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((t) => (
                      <span key={t} className="text-xs font-medium px-3 py-1 bg-blue-50/50 dark:bg-blue-900/40 text-blue-600 dark:text-blue-300 rounded-full border border-blue-100/50 dark:border-blue-800/30">
                        {t}
                      </span>
                    ))}
                  </div>
