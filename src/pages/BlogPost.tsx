    ...
    <article className="min-h-screen pt-32 pb-24 px-6 md:px-12">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <Link
            to="/"
            className="inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest text-text-secondary hover:text-accent transition-colors mb-12 group"
          >
        ...
        >
          ...
          <div className="flex items-center gap-4 mt-8 pt-8 border-t border-border/50">
            <div>
              ...
              <p className="text-xs text-text-secondary font-mono">April 2026 · 6 min read</p>
            </div>
          </div>
        </motion.header>
        ...
        {/* CTA — outside prose-custom to avoid style interference */}
        <motion.div
        ...
        >
          <p className="text-text-secondary mb-4">
            NextRole NG is live and free to use. Paste a job description, upload your CV, and see the pipeline in action.
          </p>
          <a
            href="https://nextrole-ng.vercel.app"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 font-mono text-sm uppercase tracking-widest bg-accent text-white font-semibold px-6 py-3 rounded-full hover:bg-blue-500 transition-colors no-underline"
          >
            Try NextRole NG
          </a>
        </motion.div>
