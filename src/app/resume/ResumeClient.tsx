...
export function ResumeClient() {
  ...
  const [terminalOutput, setTerminalOutput] = useState<Array<{ type: string; text: string }>>([
    { type: 'welcome', text: "Welcome to Yaqeen Maadan's Interactive CLI Resume (v1.1.0)" },
      ...
      switch (cleanCmd) {
        ...
        case 'download':
          ...
          if (typeof window !== 'undefined') {
            ...
            a.href = '/resume/Yaqeen_Maadan_Resume.pdf';
            a.download = 'Yaqeen_Maadan_Resume.pdf';
        ...
        <div>
          <aside ref={sidebarRef} className="lg:fixed lg:top-28 lg:bottom-8 lg:w-[340px] lg:overflow-y-auto flex flex-col gap-6">
            ...
            <div className="no-print">
              <a 
                href="/resume/Yaqeen_Maadan_Resume.pdf" 
                ...
                download="Yaqeen_Maadan_Resume.pdf"
              >
            ...
            <div className="flex flex-col gap-3">
              <h1 className="font-display font-bold text-[2.75rem] leading-[1.1] tracking-tighter uppercase flex flex-col">
                <span className="text-text-primary">Yaqeen</span>
